...
public class DegreeController extends HttpServlet {
    ...
    /**
     * POST,49.234.209.55://localhost:8080/degree.ctl, 增加学院
    ...
    /**
     * DELETE,49.234.209.55://localhost:8080/degree.ctl?id=1, 删除id=1的学院
    ...
    /**
     * PUT,49.234.209.55://localhost:8080/degree.ctl, 修改学院
     *
    ...
    /**
     * GET,49.234.209.55://localhost:8080/degree.ctl?id=1, 查询id=1的学院
     * GET,49.234.209.55://localhost:8080/degree.ctl, 查询所有的学院
     * 把一个或所有学院对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
